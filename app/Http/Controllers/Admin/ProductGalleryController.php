...
class ProductGalleryController extends Controller
{
    ...
    public function index()
    {
        ...
        if(request()->ajax()) {
            //panggil model productGallery  with berdasrkan relasi ke product, 
            ...
            return Datatables::of($query)
                   ...
                   ->editColumn('photos', function($item) {
                        //kembalikan dalam bentuk url dan cek dengan ternary function apakah gambar ada atau tidak
                        return $item->photos ? '<img src="'. Storage::url($item->photos).'" style="max-height: 60px;" />' : '';
                   })
